...
def main():
    ...
    output_dir = args.input_path + '_adv1'
    ...
    model3 = VGG16(2, droprate=0)
    model_path3 = './weights/VGG16.pth'
    ...
    #attack
    for ind, (img, label_true, filenames) in enumerate(loader):
        adv = attackers.attack(model,img.cuda(), label_true.cuda())
